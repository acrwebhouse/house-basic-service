exports.on = function(app) {
    ...
    app.post(preRestApi + '/getHousesByBody', function(req, res) {
        ...
        const queryInfos = house.getHouseListQueryInfos(isDelete,ownerArray,city,area,minFloor,maxFloor,minPrice,maxPrice,minPing,maxPing,minRoom,maxRoom,buildingType,typeOfRental,parking,pet,manager,garbage,smoke,cook,belongType,belongId,textQuery,minCreateTime,maxCreateTime)
