exports.on = function(app) {
    ...
    app.post(preRestApi + '/addHouse', function(req, res) {
        ...
        house.addHouse(name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,config,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,(result,data)=> {
    ...
    app.put(preRestApi + '/editHouse', function(req, res) {
       /*#swagger.parameters['obj'] = {
        ...
        house.editHouse(id,name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,config,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,(result,data)=> {
            response.status = result;
            response.data = data
            res.send(response);
        })
