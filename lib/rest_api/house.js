exports.on = function(app) {
    ...
    app.post(preRestApi + '/addHouse', function(req, res) {
        ...
        house.addHouse(name,city,area,owner,address,houseNumber,totalFloor,floor,floor2,room,price,hostName,hostPhone,hostGender,config,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,belongType,belongId,(result,data)=> {
    ...
    app.put(preRestApi + '/editHouse', function(req, res) {
       /*#swagger.parameters['obj'] = {
        ...
        house.editHouse(id,name,city,area,owner,address,houseNumber,totalFloor,floor,floor2,room,price,hostName,hostPhone,hostGender,config,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,belongType,belongId,(result,data)=> {
            response.status = result;
            response.data = data
            res.send(response);
        })
